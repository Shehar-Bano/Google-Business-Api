...
<div class="admin-page business-management-page">
    ...
    @component('admin.components.datatable', [
        ...
        'columns'   => [
            ...
            ['label' => 'Top Selling Items', 'sortable' => false],
            ...
            <tr>
                    ...
                    @if(is_array($business->top_selling_items))
                        <div class="d-flex flex-wrap gap-1">
                            @foreach($business->top_selling_items as $item)
                                <span class="badge bg-label-info">{{ $item }}</span>
                            @endforeach
                        </div>
                    @else
                ...
                <td class="text-end">
                    <div class="d-inline-flex align-items-center gap-1">
                        ...
                        <form action="{{ route('admin.business-management.destroy', $business) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this business?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="action-icon-btn action-icon-delete border-0 bg-transparent" title="Delete Business">
        ...
        @empty
            <tr>
                <td colspan="6" class="admin-empty-state">No businesses found.</td>
            </tr>
        @endforelse
    @endcomponent
...
<style>
    ...
    .um-stat-card__icon--primary { background: #eef2ff; color: #4f46e5; }
    .um-stat-card__icon--success { background: #e8f5e9; color: #2e7d32; }
    .um-stat-card__icon--warning { background: #fff3e0; color: #ef6c00; }
