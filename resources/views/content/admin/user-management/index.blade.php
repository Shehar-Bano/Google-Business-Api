            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center gap-2">
                        <div class="um-user-avatar">{{ strtoupper(substr($user->name, 0, 1)) }}</div>
                        <div>
                            <div class="cell-primary">{{ $user->name }}</div>
                            @if($user->club_name)
                                <div class="cell-muted">{{ $user->club_name }}</div>
                            @endif
                        </div>
                    </div>
                </td>
...
<style>
    ...
    .um-stat-card__icon--otp_pending { background: #f1f5f9; color: #64748b; }
    .um-stat-card__icon--suspended   { background: #1e293b; color: #f1f5f9; }
