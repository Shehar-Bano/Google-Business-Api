...
<div class="admin-page">
    ...
    <div class="admin-page-header d-flex justify-content-between align-items-center mb-4">
        <div class="admin-page-header__left">
            ...
            <p class="admin-page-header__subtitle">Updating pricing plan #{{ $subscriptionPlan->id }} ({{ $subscriptionPlan->title }})</p>
        </div>
        <div>
    ...
    <div class="card mb-4" style="max-width: 750px;">
        <div class="card-header border-bottom"><h5 class="mb-0 fw-bold">Edit Plan Details</h5></div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <div class="form-check form-switch mt-1">
                            ...
                            <input class="form-check-input" type="checkbox" name="is_popular" value="1" id="is_popular" @checked(old('is_popular', $subscriptionPlan->is_popular) == 1)>
                    ...
                    <div class="col-12 mb-4">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <label class="form-label fw-semibold mb-0" for="feature_ids">Plan Features (Select2 Multi-Select)</label>
                        ...
                        <select name="feature_ids[]" id="feature_ids" class="form-select select2-multiple" multiple="multiple" style="width: 100%;">
                            @foreach($features as $feature)
                                <option value="{{ $feature->id }}" @selected(in_array($feature->id, old('feature_ids', $selectedFeatureIds)))>
