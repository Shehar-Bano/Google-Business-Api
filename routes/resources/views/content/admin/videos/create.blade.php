...
<div class="admin-page videos-page">
    <div class="admin-page-header mb-4">
        <div class="admin-page-header__left">
            <h4 class="admin-page-header__title">Add Video Short</h4>
            <p class="admin-page-header__subtitle">Map a YouTube short URL to a specific app screen name.</p>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="screen_name" id="screen_name" class="form-control @error('screen_name') is-invalid @enderror" value="{{ old('screen_name') }}" placeholder="e.g. business_name" required>
                            @error('screen_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="url" name="video_url" id="video_url" class="form-control @error('video_url') is-invalid @enderror" value="{{ old('video_url') }}" placeholder="https://youtube.com/shorts/..." required>
                            @error('video_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card">
                    <div class="card-body d-grid gap-2">
                        <button type="submit" class="btn btn-dark">
                            <i class="mdi mdi-check me-1"></i> Save Video Mappings
                        </button>
